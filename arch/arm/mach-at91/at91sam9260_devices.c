...
static struct resource eth_resources[] = {
	[0] = {
		...
		.end	= AT91SAM9260_BASE_EMAC + SZ_128K - 1,
		//.end	= AT91SAM9260_BASE_EMAC + SZ_4K - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
...
#if defined(CONFIG_AT91_GPIO) || defined(CONFIG_AT91_GPIO_MODULE)

static struct resource gpio_resources[] = {
	{
		.start	= AT91_BASE_SYS + AT91_PIOA,
		.end	= AT91_BASE_SYS + AT91_PIOA + ( SZ_512 * 3 ) - 1,
		.flags	= IORESOURCE_MEM,
	},
};

static struct platform_device at91sam9260_gpio_device = {
	.name		= "at91_gpio",
	.id		= -1,
...
void __init at91_add_device_gpio(void)
{
	platform_device_register(&at91sam9260_gpio_device);
}
#else
void __init at91_add_device_gpio(void) {}
#endif
 ...
 * -------------------------------------------------------------------- */
#if 0
#if defined(CONFIG_EDDY_ADC) || defined(CONFIG_EDDY_ADC_MODULE)
...
void __init at91_add_device_rtt(void)
{
...
#if defined(CONFIG_AT91SAM9260_WATCHDOG)
...
void __init at91_add_device_watchdog(void)
{
...
static struct resource uart0_resources[] = {
	[0] = {
		...
		//	.end	= AT91SAM9260_BASE_US0 + SZ_4K - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
...
/* --------------------------------------------------------------------
 *  Adjust Bus Matrix Priorities
 * -------------------------------------------------------------------- */

#ifndef CONFIG_INNOPIATECH	/* CHWKIM - 2007-11-05 */
void __init at91_adj_bus_matrix_pri(void)
{
	unsigned long pras, scfg;

#ifdef CHWKIM_DEBUG
	printk("Initial Bus Matrix Value\n");
	printk("PRAS0 = 0x%x\n", at91_sys_read(AT91_MATRIX_PRAS0));
	printk("PRAS1 = 0x%x\n", at91_sys_read(AT91_MATRIX_PRAS1));
	printk("PRAS2 = 0x%x\n", at91_sys_read(AT91_MATRIX_PRAS2));
	printk("PRAS3 = 0x%x\n", at91_sys_read(AT91_MATRIX_PRAS3));
	printk("PRAS4 = 0x%x\n", at91_sys_read(AT91_MATRIX_PRAS4));
	printk("SCFG0 = 0x%x\n", at91_sys_read(AT91_MATRIX_SCFG0));
	printk("SCFG1 = 0x%x\n", at91_sys_read(AT91_MATRIX_SCFG1));
	printk("SCFG2 = 0x%x\n", at91_sys_read(AT91_MATRIX_SCFG2));
	printk("SCFG3 = 0x%x\n", at91_sys_read(AT91_MATRIX_SCFG3));
	printk("SCFG4 = 0x%x\n", at91_sys_read(AT91_MATRIX_SCFG4));
#endif
	/*
	 * Priority Reg for Slave 0(SRAM 0), 1(SRAM 1)
	 *	- set M4PR(EMAC) to 3
	 */
	pras = at91_sys_read(AT91_MATRIX_PRAS0);
	at91_sys_write(AT91_MATRIX_PRAS0, pras | (0x3 << 16));
	pras = at91_sys_read(AT91_MATRIX_PRAS1);
	at91_sys_write(AT91_MATRIX_PRAS1, pras | (0x3 << 16));

	/*
	 * Priority Reg for Slave 3 (EBI)
	 *	- set M4PR(EMAC) to 2
	 */
	pras = at91_sys_read(AT91_MATRIX_PRAS3);
	at91_sys_write(AT91_MATRIX_PRAS3, pras | (0x2 << 16));

	/*
	 * Slave Configuration Register
	 *	- Fixed Priority Arbitration
	 */
	scfg = at91_sys_read(AT91_MATRIX_SCFG0);
	at91_sys_write(AT91_MATRIX_SCFG0, scfg|AT91_MATRIX_ARBT_FIXED_PRIORITY);
	scfg = at91_sys_read(AT91_MATRIX_SCFG1);
	at91_sys_write(AT91_MATRIX_SCFG1, scfg|AT91_MATRIX_ARBT_FIXED_PRIORITY);
	scfg = at91_sys_read(AT91_MATRIX_SCFG2);
	at91_sys_write(AT91_MATRIX_SCFG2, scfg|AT91_MATRIX_ARBT_FIXED_PRIORITY);
	scfg = at91_sys_read(AT91_MATRIX_SCFG3);
	at91_sys_write(AT91_MATRIX_SCFG3, scfg|AT91_MATRIX_ARBT_FIXED_PRIORITY);
	scfg = at91_sys_read(AT91_MATRIX_SCFG4);
	at91_sys_write(AT91_MATRIX_SCFG4, scfg|AT91_MATRIX_ARBT_FIXED_PRIORITY);

#ifdef CHWKIM_DEBUG
	printk("Changed Bus Matrix Value\n");
	printk("PRAS0 = 0x%x\n", at91_sys_read(AT91_MATRIX_PRAS0));
	printk("PRAS1 = 0x%x\n", at91_sys_read(AT91_MATRIX_PRAS1));
	printk("PRAS2 = 0x%x\n", at91_sys_read(AT91_MATRIX_PRAS2));
	printk("PRAS3 = 0x%x\n", at91_sys_read(AT91_MATRIX_PRAS3));

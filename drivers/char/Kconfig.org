...
config EDDY_GPIO
	tristate "Eddy V2.0 GPIO Support"
	depends on (ARM && ARCH_AT91) || AVR32
	select EDDY_GPIO		# needed for support routines
	# selected by SCx200_GPIO and PC8736x_GPIO
	# what about 2 selectors differing: m != y
	help
	  Common support used (and needed) by systembase Eddy V2.0 and
	  eddy_gpio drivers.  If those drivers are built as
	  modules, this one will be too, named eddy_gpio

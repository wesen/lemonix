...
#define AT25_CHIP_SELECT 0 
static const unsigned spi1_chip_select[4] = { AT91_PIN_PB3, AT91_PIN_PC5, AT91_PIN_PC4, AT91_PIN_PC3 };
...
static int __init at25_init(void)
{
	...
	cs_num = AT25_CHIP_SELECT;
	cs_pin = spi1_chip_select[cs_num];

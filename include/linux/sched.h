...
# define mcount() do { } while (0)
  ...
  extern void trace_hyper(unsigned long v1, unsigned long v2, unsigned long v3);
...
# define trace_hyper(v1,v2,v3)			do { } while (0)
...
extern void exit_kvm_vcpu(struct task_struct *t);
